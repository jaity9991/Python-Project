...
class Welcome:
    def __init__(self,root):
        ...
        Frame_Welcome.place(x=21,y=21,height=410,width=500)            
        
        title=Label(Frame_Welcome,text="Login Portal",font=('times',25,"bold","italic"),fg="Black",bg="#66CCCC").place(x=30,y=30)
        desc=Label(Frame_Welcome,text="Employee Login Area",font=('calligrapher',12,"italic"),fg="red",bg="#66CCCC",pady=15).place(x=30,y=70)
